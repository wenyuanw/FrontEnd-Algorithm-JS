...
var toPrecision = function toPrecision(num, precision, unit) {
  return Number(num.toFixed(unit === 'px' ? 0 : precision)).toString();
};
...
module.exports = {
    AnPlusB: __webpack_require__(80),
    Atrule: __webpack_require__(81),
    AtrulePrelude: __webpack_require__(82),
    AttributeSelector: __webpack_require__(83),
    Block: __webpack_require__(84),
    Brackets: __webpack_require__(85),
    CDC: __webpack_require__(86),
    CDO: __webpack_require__(87),
    ClassSelector: __webpack_require__(88),
    Combinator: __webpack_require__(89),
    Comment: __webpack_require__(90),
    Declaration: __webpack_require__(91),
    DeclarationList: __webpack_require__(92),
    Dimension: __webpack_require__(93),
    Function: __webpack_require__(94),
    HexColor: __webpack_require__(95),
    Identifier: __webpack_require__(96),
    IdSelector: __webpack_require__(97),
    MediaFeature: __webpack_require__(98),
    MediaQuery: __webpack_require__(99),
    MediaQueryList: __webpack_require__(100),
    Nth: __webpack_require__(101),
    Number: __webpack_require__(102),
    Operator: __webpack_require__(103),
    Parentheses: __webpack_require__(104),
    Percentage: __webpack_require__(105),
    PseudoClassSelector: __webpack_require__(106),
    PseudoElementSelector: __webpack_require__(107),
    Ratio: __webpack_require__(108),
    Raw: __webpack_require__(109),
    Rule: __webpack_require__(110),
    Selector: __webpack_require__(111),
    SelectorList: __webpack_require__(112),
    String: __webpack_require__(113),
    StyleSheet: __webpack_require__(114),
    TypeSelector: __webpack_require__(115),
    UnicodeRange: __webpack_require__(116),
    Url: __webpack_require__(117),
    Value: __webpack_require__(118),
    WhiteSpace: __webpack_require__(119)
};
...
var _isEmpty2 = __webpack_require__(2);

var _isEmpty3 = _interopRequireDefault(_isEmpty2);

var _toPrecision = __webpack_require__(5);

var _toPrecision2 = _interopRequireDefault(_toPrecision);

var _optimizeOutput = __webpack_require__(28);

var _optimizeOutput2 = _interopRequireDefault(_optimizeOutput);

var _sanitizeValues = __webpack_require__(44);

var _sanitizeValues2 = _interopRequireDefault(_sanitizeValues);

var _getInterpolator = __webpack_require__(47);

var _getInterpolator2 = _interopRequireDefault(_getInterpolator);

var _parseDeclarations = __webpack_require__(49);

var _parseDeclarations2 = _interopRequireDefault(_parseDeclarations);

var _getAnimationValues = __webpack_require__(123);

var _getAnimationValues2 = _interopRequireDefault(_getAnimationValues);

var _buildKeyframeObject = __webpack_require__(124);

var _buildKeyframeObject2 = _interopRequireDefault(_buildKeyframeObject);

var _addInterpolatedValues = __webpack_require__(125);

var _addInterpolatedValues2 = _interopRequireDefault(_addInterpolatedValues);
...
var presets = {
  ...
  var _Object$assign = Object.assign({}, defaultOptions, options, presets[options.preset] || {}),
      keyframePrecision = _Object$assign.keyframePrecision,
      precision = _Object$assign.precision,
      steps = _Object$assign.steps,
      tension = _Object$assign.tension,
      wobble = _Object$assign.wobble;
  ...
  var declarations = (0, _sanitizeValues2.default)((0, _getAnimationValues2.default)((0, _parseDeclarations2.default)(startStyles), (0, _parseDeclarations2.default)(endStyles)));

  // quit if there are no interpolatable declarations
  if ((0, _isEmpty3.default)(declarations)) {
    return;
  }

  var interpolator = (0, _getInterpolator2.default)(tension, wobble, steps);

  // calculate keyframe percentages
  var keyframePercentages = [].concat(_toConsumableArray(Array(steps + 1))).map(function (_, i) {
    return (0, _toPrecision2.default)(i * 100 / steps, keyframePrecision) + '%';
  });

  // calculate interpolated values and add them to the declarations
  var declarationsWithInterpolatedValues = (0, _addInterpolatedValues2.default)(interpolator, declarations, precision);

  return (0, _optimizeOutput2.default)((0, _buildKeyframeObject2.default)(declarationsWithInterpolatedValues, keyframePercentages));
};
...
exports.removeConsecutiveValues = undefined;

var _omitBy2 = __webpack_require__(29);
...
var removeConsecutiveValues = exports.removeConsecutiveValues = function removeConsecutiveValues(keyframes) {
  var last = {};
  var beforeLast = {};
  ...
  try {
    for (var _iterator = Object.keys(keyframes)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var percentage = _step.value;

      var keyframe = keyframes[percentage];
      var _iteratorNormalCompletion2 = true;
      var _didIteratorError2 = false;
      var _iteratorError2 = undefined;

      try {
        for (var _iterator2 = Object.keys(keyframe)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var property = _step2.value;

          var value = keyframe[property];
          if (last[property] && beforeLast[property] && last[property].value === value && beforeLast[property].value === value) {
            delete keyframes[last[property].percentage][property];
          }
          beforeLast[property] = last[property];
          last[property] = { percentage: percentage, value: value };
        }
      } catch (err) {
...
var optimizeOutput = function optimizeOutput(keyframes) {
  return (0, _omitBy3.default)(removeConsecutiveValues(keyframes), _isEmpty3.default);
};

exports.default = optimizeOutput;
...
var baseIteratee = __webpack_require__(6),
    negate = __webpack_require__(30),
    pickBy = __webpack_require__(31);
...
var arrayMap = __webpack_require__(32),
    ...
    basePickBy = __webpack_require__(33),
    getAllKeysIn = __webpack_require__(43);
...
var getAnimatableValues = exports.getAnimatableValues = function getAnimatableValues(startValues, endValues) {
  return compact(map(startValues, function (start, i) {
    var end = endValues[i];
    ...
    switch (start.type) {
      ...
      case 'Operator':
        return start.value !== end.value ? null : { type: 'Fixed', value: start.value };
      case 'Identifier':
        return start.name !== end.name ? null : { type: 'Fixed', value: start.name };
      case 'Dimension':
        return start.unit !== end.unit ? null : {
          type: start.type,
          unit: start.unit,
          start: +start.value,
          end: +end.value
      ...
      case 'Number':
        return start.value !== end.value ? { type: start.type, start: +start.value, end: +end.value } : { type: 'Fixed', value: start.value };
      case 'HexColor':
        return { type: start.type, start: start.value, end: end.value };
      case 'Function':
        var values = getAnimatableValues(start.children.toArray(), end.children.toArray());
        return values.length !== start.children.toArray().length ? null : { type: start.type, name: start.name, values: values };
      default:
...
var sanitizeValues = function sanitizeValues(values) {
  var result = {};

  Object.keys(values).forEach(function (prop) {
    var _values$prop = values[prop],
        startValues = _values$prop.start,
        endValues = _values$prop.end;

    var animatable = getAnimatableValues(startValues, endValues);
...
exports.default = sanitizeValues;
...
var springer = __webpack_require__(48).default;

var toSixDigits = exports.toSixDigits = function toSixDigits(hex) {
  return hex.length === 3 ? '' + hex[0] + hex[0] + hex[1] + hex[1] + hex[2] + hex[2] : hex;
};

var interpolateColor = exports.interpolateColor = function interpolateColor(a, b, amount) {
  a = toSixDigits(a);
  b = toSixDigits(b);
...
var getInterpolator = function getInterpolator(tension, wobble, steps) {
  var spring = springer(tension, wobble);

  return {
    fixed: function fixed(value) {
      return [].concat(_toConsumableArray(Array(steps + 1))).map(function (_) {
        return value;
      });
    },
    number: function number(start, end) {
      return [].concat(_toConsumableArray(Array(steps + 1))).map(function (_, i) {
        return start + (end - start) * spring(i / steps);
      });
    },
    hex: function hex(start, end) {
      return [].concat(_toConsumableArray(Array(steps + 1))).map(function (_, i) {
        return interpolateColor(start, end, spring(i / steps));
      });
    }
  };
};
...
function Springer() {
  var tension = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0.5;
  var wobble = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0.5;
  ...
  while (progress !== sampleDuration || velocity !== 0) {
    var _stepper = stepper(progress, sampleDuration, velocity, stiffness, damping);
...
//# sourceMappingURL=data:application/json;base64,
...
var parse = __webpack_require__(50); // function
...
var parseDeclarations = function parseDeclarations(styles) {
  var result = [];
  var randomNumber = Math.floor(Math.random() * 1e5);
...
exports.default = parseDeclarations;

/***/ }),
/* 50 */
/***/ (function(module, exports, __webpack_require__) {

var createParser = __webpack_require__(51);
...
var CssSyntaxError = __webpack_require__(53);
...
module.exports = {
    ...
    scope: __webpack_require__(57),
    atrule: __webpack_require__(63),
    pseudo: __webpack_require__(69),
...
module.exports = {
    AtrulePrelude: __webpack_require__(58),
    Selector: __webpack_require__(59),
...
module.exports = {
    getNode: __webpack_require__(10)
};
...
module.exports = {
    getNode: __webpack_require__(10),
    '-moz-element': __webpack_require__(11),
...
module.exports = {
    'font-face': __webpack_require__(64),
    'import': __webpack_require__(65),
    'media': __webpack_require__(66),
    'page': __webpack_require__(67),
    'supports': __webpack_require__(68)
};
...
module.exports = {
    'dir': __webpack_require__(70),
    'has': __webpack_require__(71),
    'lang': __webpack_require__(72),
    'matches': __webpack_require__(73),
    'not': __webpack_require__(74),
    'nth-child': __webpack_require__(75),
    'nth-last-child': __webpack_require__(76),
    'nth-last-of-type': __webpack_require__(77),
    'nth-of-type': __webpack_require__(78),
    'slotted': __webpack_require__(79)
};
...
var createWalker = __webpack_require__(121);
...
var _require = __webpack_require__(8),
    ...
    intersectionBy = _require.intersectionBy,
    map = _require.map,
...
var getLastPropertyValue = exports.getLastPropertyValue = function getLastPropertyValue(declarations, prop) {
  return findLast(declarations, function (d) {
    return d.property === prop;
...
var getAnimationValues = function getAnimationValues(startDec, endDec) {
  return reduce(intersectionBy(map(startDec, 'property'), map(endDec, 'property')), function (accu, prop) {
    return Object.assign(accu, _defineProperty({}, prop, {
...
exports.default = getAnimationValues;
...
var addOrApppend = exports.addOrApppend = function addOrApppend(obj, key, value) {
  return Object.assign(obj, _defineProperty({}, key, '' + (obj[key] || '') + value));
};

var getFunctionValue = exports.getFunctionValue = function getFunctionValue(values, step) {
  return values.map(function (part) {
    return part.values ? part.values[step] : '';
  }).join('');
};

var buildKeyframeObject = function buildKeyframeObject(obj, keyframePercentages) {
  var result = {};

  var _loop = function _loop(i) {
    var element = keyframePercentages[i];
    result[element] = {};
    ...
    try {
      var _loop2 = function _loop2() {
        ...
        result[element] = obj[key].reduce(function (accu, part) {
          switch (part.type) {
            case 'Dimension':
            case 'Fixed':
            case 'HexColor':
            ...
            case 'Function':
              return addOrApppend(result[element], key, part.name + '(' + getFunctionValue(part.values, i) + ')');
          }
  ...
  for (var i = 0; i < keyframePercentages.length; i++) {
    _loop(i);
  }
  return result;
};

exports.default = buildKeyframeObject;
...
exports.addInterpolatedValue = exports.assignValues = undefined;
...
var assignValues = exports.assignValues = function assignValues(obj, values) {
  return Object.assign(obj, { values: values });
};

var addInterpolatedValue = exports.addInterpolatedValue = function addInterpolatedValue(interpolator, parts, precision) {
  return parts.map(function (part) {
    switch (part.type) {
      case 'Function':
        return assignValues(part, addInterpolatedValue(interpolator, part.values, precision));
      case 'Dimension':
        return assignValues(part, interpolator.number(part.start, part.end).map(function (v) {
          var rounded = (0, _toPrecision2.default)(v, precision, part.unit);
          return rounded === '0' ? '0' : '' + rounded + part.unit;
        }));
      case 'Number':
        return assignValues(part, interpolator.number(part.start, part.end).map(function (v) {
          return (0, _toPrecision2.default)(v, precision);
        }));
      case 'HexColor':
...
var addInterpolatedValues = function addInterpolatedValues(interpolator, values, precision) {
  var _iteratorNormalCompletion = true;
  var _didIteratorError = false;
  var _iteratorError = undefined;
...
exports.default = addInterpolatedValues;
